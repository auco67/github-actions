...
const Layer = __nccwpck_require__(5624);
const Router = __nccwpck_require__(4963);
...
var send = __nccwpck_require__(2966);
...
var deprecate = __nccwpck_require__(8883)('express');
var flatten = __nccwpck_require__(3723);
var mime = (__nccwpck_require__(2966).mime);
...
var destroy = __nccwpck_require__(3225)
var encodeUrl = __nccwpck_require__(9824)
var escapeHtml = __nccwpck_require__(4070)
var etag = __nccwpck_require__(9972)
var fresh = __nccwpck_require__(3136)
var fs = __nccwpck_require__(7147)
...
var lib = __nccwpck_require__(5287);
...
// EXTERNAL MODULE: ./node_modules/express-async-errors/index.js
var express_async_errors = __nccwpck_require__(1457);
// EXTERNAL MODULE: ./node_modules/morgan/index.js
var morgan = __nccwpck_require__(4460);
var morgan_default = /*#__PURE__*/__nccwpck_require__.n(morgan);
;// CONCATENATED MODULE: ./src/sum.ts
function sum(v1, v2) {
    return v1 + v2;
}
...
app.use(morgan_default()('combined'));
app.use(express_default()["static"]('../frontend', { extensions: ['html'] }));
app.use(lib_default()({ origin: CORS_ORIGIN }));
